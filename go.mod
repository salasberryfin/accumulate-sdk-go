module github.com/salasberryfin/accumulate-sdk-go

go 1.17

require github.com/AccumulateNetwork/accumulate v0.2.2-0.20211126221634-72db7a0fbac9
...
require (
	...
	github.com/tendermint/tendermint v0.35.0-rc1 // indirect
